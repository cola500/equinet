...
const providerMoreItems: MoreMenuItem[] = [
  ...
  { href: "/provider/voice-log", label: "Logga arbete", icon: Mic, matchPrefix: "/provider/voice-log" },
...
const navItems = [
  ...
  { href: "/provider/voice-log", label: "Logga arbete", matchPrefix: "/provider/voice-log" },
