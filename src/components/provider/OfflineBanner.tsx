    ...
    return (
      <>
        <button
          type="button"
          role="alert"
          className="w-full bg-red-50 border-b border-red-200 px-4 py-2 text-left hover:bg-red-100 transition-colors"
          onClick={() => setQueueViewerOpen(true)}
        >
        ...
        <MutationQueueViewer open={queueViewerOpen} onOpenChange={setQueueViewerOpen} />
      </>
    )
  }
