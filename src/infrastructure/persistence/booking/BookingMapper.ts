...
export class BookingMapper implements IMapper<Booking, PrismaBooking> {
  toDomain(prisma: PrismaBooking): Booking {
    return {
      ...
      providerNotes: prisma.providerNotes ?? undefined,
      cancellationMessage: prisma.cancellationMessage ?? undefined,
      rescheduleCount: prisma.rescheduleCount,
      bookingSeriesId: prisma.bookingSeriesId ?? undefined,
  ...
  toPersistence(domain: Booking): PrismaBooking {
    return {
      ...
      providerNotes: domain.providerNotes ?? null,
      cancellationMessage: domain.cancellationMessage ?? null,
      rescheduleCount: domain.rescheduleCount,
      bookingSeriesId: domain.bookingSeriesId ?? null,
