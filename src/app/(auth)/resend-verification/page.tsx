  ...
  const onSubmit = async (data: ResendInput) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(result.error || "Nagot gick fel")
      }
    } catch {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription>
              Om e-postadressen finns i vart system har vi skickat ett nytt verifieringsmail.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link href="/login">
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            Ange din e-postadress sa skickar vi ett nytt verifieringsmail.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button type="submit" className="w-full" disabled={isLoading}>
              {isLoading ? "Skickar..." : "Skicka verifieringsmail"}
            </Button>
