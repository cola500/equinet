  ...
  return (
    <ProviderLayout>
      ...
      <p className="text-gray-600 mb-8">
        ...
        20). Exporten innehåller dina personuppgifter, företagsinformation,
        tjänster, bokningar, anteckningar och recensioner.
      </p>
      ...
      <Card className="mt-8">
        <CardContent className="py-6">
          ...
          <ul className="text-sm text-gray-600 space-y-1 list-disc pl-5">
            <li>Dina personuppgifter (namn, email, telefon)</li>
            <li>Företagsinformation (namn, beskrivning, adress)</li>
            <li>Alla dina tjänster</li>
            <li>Alla bokningar (genomförda, kommande, avbokade)</li>
            <li>Anteckningar du skapat</li>
            <li>Recensioner från kunder</li>
          </ul>
