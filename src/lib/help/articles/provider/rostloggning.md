...
> Fungerar bäst med korta, koncisa beskrivningar ("Verkade fram, normalställd, klipper lite kil"). Du kan logga flera bokningar i rad med "Logga nästa"-flödet. Röstinspelning fungerar i Chrome och Safari. I Firefox används textfältet.

> Den här funktionen kan vara inaktiverad och kanske inte är tillgänglig i alla konton.
