        ...
        headers: [
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              `connect-src 'self' https://router.project-osrm.org https://*.supabase.co https://*.sentry.io${isDev ? ' http://localhost:54321 http://127.0.0.1:54321' : ''}`, // Allow OSRM API + Supabase + Sentry (+ local Supabase in dev)
        ...
        headers: [
          // Content Security Policy
          {
            ...
            value: [
              ...
              `connect-src 'self' https://*.supabase.co https://*.sentry.io https://api.stripe.com${isDev ? ' http://localhost:54321 http://127.0.0.1:54321' : ''}`, // API calls + Supabase + Sentry + Stripe (+ local Supabase in dev)
