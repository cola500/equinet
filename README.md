...
- **Testning**: Vitest (4302 unit/integration) + Playwright (22 E2E-specs) + 312 iOS XCTest = 70% coverage
...
**4636+ tester** (4302 Vitest unit/integration + 312 iOS XCTest + 22 E2E-specs) med **70% coverage**.
