-- Supabase Auth triggers for local development and E2E
--
...
--
-- WHEN TO RUN: After `prisma migrate deploy` has created the public tables.
-- In CI: see .github/workflows/quality-gates.yml (e2e-tests job)
-- Locally: `npm run test:e2e:bootstrap` or manually:
--   psql "$DATABASE_URL" -f supabase/auth-triggers.sql
--
