...
> Genererad av `npm run metrics:report` — 2026-04-20 18:25:58
...
- Antal stories analyserade: 50 av 188 (kräver matchande plan-fil i docs/plans/)
...
- Totalt kontrollerade (med Docs-sektion): 94
...
- Totalt kontrollerade (stories med Modell-fält): 56
- Avvikelser: 2
