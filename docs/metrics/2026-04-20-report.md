...
> Genererad av `npm run metrics:report` — 2026-04-20 09:44:07
...
- Stories med agent-review: 91
- Stories med minst ett fynd (blocker/major): 75
- Hit-rate: 82,4% (hur ofta agenter hittar reella problem)
- Stories med blocker: 45
...
- Antal stories analyserade: 44 av 182 (kräver matchande plan-fil i docs/plans/)
...
- Totalt kontrollerade (med Docs-sektion): 88
...
- Totalt kontrollerade (stories med Modell-fält): 50
- Avvikelser: 2
