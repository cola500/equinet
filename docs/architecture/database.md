...
**35 tabeller** med index optimerade för vanliga queries:

| Tabell | Kritiska Index | Syfte |
|--------|----------------|-------|
| User | email, latitude/longitude, municipality | Användarkonton |
...
| HorseServiceInterval | horseId+providerId+serviceId (unique) | Återbesöksintervall per häst, leverantör och tjänst |
