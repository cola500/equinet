...
- [x] Fraga 1 besvarad: Kan vi anvanda RLS med Prisma direkt-anslutning? **Ja, via Client Extensions + set_config() i transaction. Men Prismas eget exempel varnar for produktion.**
...
- [x] Fraga 3 besvarad: PoC pa en tabell? **Mojligt men kraver att ALLA 83+ access-punkter wrappas i RLS-aware extension.**
...
2. **Single-tenant minskar RLS-vardet.** RLS ar mest vardefullt i multi-tenant-miljoer. Equinet ar single-tenant per deployment -- en leverantor per instans.
