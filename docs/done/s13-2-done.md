...
1. **MobileToken Prisma-modell behalls** -- flyttad till S13-3 (schema-andring efter produktionsvalidering). Rekommendation fran bade tech-architect och security-reviewer.
...
2. **authMethod-typen kravde bulk-update av ~65 testfiler** -- sed var effektivt men skapade syntaxfel i 3 filer. Manuell fix kravdes. Lardomen: sed pa multi-line patterns ar risky, anvand grep + manuell fix for komplexa ersattningar.
