...
| S13-2 Ta bort NextAuth + MobileToken | fullstack | Dev | done | feature/s13-2-remove-nextauth | 50d90b07 |
...
|---------|------|-----------|--------|---------|
| Dev | Fullstack | S13-2 Ta bort NextAuth + MobileToken | feature/s13-2-remove-nextauth | 2026-04-04 |
