...
|-------|------|----------|--------|--------|----------------|
| S24-1 Extrahera BookingValidation | fullstack (webb) | Session 1 | in_progress | feature/s24-1-booking-validation | - |
...
|---------|------|-----------|--------|---------|
| Sprint 24 Session 1 | fullstack (webb) | S24-1 | feature/s24-1-booking-validation | 2026-04-12 |
